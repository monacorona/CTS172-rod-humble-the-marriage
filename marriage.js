...
var Brown = rgba(61, 48, 24, 1.00)
var Gray = rgba(39, 39, 39, 1.0)
var End = rgba(5, 2, 24, 1.00)
var Dark = rgba(92, 21, 0, 1.00)

var SplashBackgroundColor = Brown
var BackgroundColors = [Dark, Blue, Purple, Pink, Green, Brown, Gray, End]
...
var ElementColors = [
	rgba(232, 144, 255, 1.00), 	// Affair/Other Girl 1
	rgba(255, 55, 64, 1.00),	// Affair/Other Girl 2
	rgba(190, 141, 222, 1.00),	// Old Flame/ Other Girl 3
	rgba(233, 208, 53, 1.00),	// Ex
	rgba(10, 218, 197, 1.00),	// His Friends
	BlackElement				// Black - Her BFF/Friends/Family
]
...
var FemaleKissGrowth = 2
var FemaleHitsElementGrowth = -8
var FemaleHitsBlackElementGrowth = 13
var FemaleGrowthWhenElementDisappears = 4
var FemaleLifeIncreaseOnKiss = 0.2
var FemaleLifeOverTime = -0.0179
var FemaleLifeMultiplierOnLevel5 = 1.18
var FemaleGrowthOverTime = -0.05
var FemaleGrowthSpeedOnCharacterTouch = -8

var MaleHitsElementGrowth = 12
var MaleHitsElementLifeIncrease = 0.3
var MaleHitsBlackElementGrowth = -15
var MaleLifeIncreaseOnKiss = 0.23
var MaleGrowthSpeedOnCharacterTouch = -4
var MaleSprintSpeed = 60
...
var MemoryBarGrowthWhenFemaleHitsElement = 4
...
function Character (gender)
{
	...
	this.logic = function()
	{
		...
		if(isPointInsideRect(mMousePosition, this.rect))
		{
			...
			mFemale.expand(FemaleGrowthSpeedOnCharacterTouch * mDeltaTime)
			attract()
		}
...
function drawSplash(alpha)
{
	...
	drawText('The Affair', titlePosition, 25, 'center', textColor)
	drawText('Rod Humble 2006 - Edited by Mona Taleb-Agha 2018', creditsPosition, 12,  'right', textColor)
